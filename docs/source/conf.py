...
from spyda import version_info
...
project = u'spyda'
copyright = u'CopyRight (C) 2012-2013 by James Mills'
...
man_pages = [
    ('index', 'spyda', u'spyda Documentation',
     [u'James Mills'], 1)
]
...
texinfo_documents = [
    (
        'index', 'spyda', u'spyda Documentation',
        u'James Mills', 'spyda', 'Python Web Crawler, Article Extraction and Entity Matching Tool(s) and Library.',
        'Miscellaneous'
    ),
]
